...
class User(db.Model):
    ...
    book_list=db.relationship("Book", backref="author", lazy="dynamic", cascade='all, delete-orphan')
...
class Book(db.Model): 
    ...
    def to_dict(self):
        return {"user_id":self.user_id, "title": self.title, "author": self.author, "pages": self.pages, "summary":self.summary, "img": self.img, "subject": self.subject, "book_id":self.book_id}
